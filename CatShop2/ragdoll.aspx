...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        body {
         ...
         .upper-section {
     background-image: url('imgs/ragdollcat.jpg'); /* Replace 'background-image.jpg' with your actual image path */
     background-size: cover;
     background-position: center;
     background-repeat: no-repeat;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <td>1</td>
         <td>Beef</td>
         <td><img src="imgs/siamesebeef.jpg" alt="Food 1" width="60" height="60" /></td>
         </tr>
       <tr>
         <td>2</td>
         <td>CHicken</td>
         <td><img src="imgs/siamesechicken.jpg" alt="Food 2" width="60" height="60" /></td>
     </tr>
     <tr>
         <td>3</td>
         <td>Dental Biscuits</td>
         <td><img src="imgs/ragdolldentalbiscuits.jpg" alt="Food 3" width="60" height="60" /></td>
     </tr>
     <tr>
         <td>4</td>
         <td>Tuna</td>
         <td><img src="imgs/siamesetuna.jpg" alt="Food 4" width="60" height="60" /></td>
     </tr>
     <tr>
         <td>5</td>
         <td>Salmon</td>
         <td><img src="imgs/siamesesalmon.jpg" alt="Food 5" width="60" height="60" /></td>
     </tr>
 </tbody>
        </table>
