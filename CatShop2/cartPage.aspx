<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="cartPage.aspx.cs" Inherits="CatShop2.cartPage" %>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center mb-4">
                            <img id="imgview" class="img-fluid" src="Cat_inventory/cat_img.png" alt="Cat Image" />
                        </div>
                        <hr>
                        <div class="form-group row">
                            <div class="col-md-6">
                                <label class="font-weight-bold">Cat ID:</label>
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">Breed Name:</label>
