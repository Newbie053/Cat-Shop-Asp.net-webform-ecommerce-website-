...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        body {
         ...
         .upper-section {
     background-image: url('imgs/siamesecat.jpg'); /* Replace 'background-image.jpg' with your actual image path */
     background-size: cover;
     background-position: center;
     background-repeat: no-repeat;
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>3</td>
                    <td>Pork</td>
                    <td><img src="imgs/siamesepork.jpg" alt="Food 3" width="60" height="60" /></td>
                </tr>
                <tr>
                    <td>4</td>
                    <td>Tuna</td>
