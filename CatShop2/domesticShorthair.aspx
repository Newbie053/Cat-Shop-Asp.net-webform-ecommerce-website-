...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        body {
         ...
         .upper-section {
     background-image: url('imgs/domesticshorthair.jpg'); /* Replace 'background-image.jpg' with your actual image path */
     background-size: cover;
     background-position: center;
     background-repeat: no-repeat;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="header">
            <h1>Domestic Shorthair Cat Diet Chart</h1>
        </div>
            ...
            <tbody>
              ...
              /tr>
                <tr>
                    <td>5</td>
                    <td>Milk</td>
                    <td><img src="imgs/domesticshorthairmilk.jpg" alt="Food 5" width="60" height="60" /></td>
                </tr>
            </tbody>
        </table>
